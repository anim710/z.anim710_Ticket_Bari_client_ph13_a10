...
export default function TicketForm({
  ...
  const selectCls =
    "bg-slate-50 text-slate-900 dark:bg-[#0d0e12] dark:text-slate-700 border border-slate-200 hover:border-slate-300 rounded-xl px-3 h-[40px] text-sm focus:outline-none focus:ring-2 focus:ring-primary w-full transition-all cursor-pointer shadow-sm";
